...
[Открыть интерактивное статическое демо](https://an724275-hash.github.io/service-desk-django/). На GitHub Pages работает только интерфейс с вымышленными данными; Django-сервер, авторизация и база данных доступны при локальном запуске.
...
- Аналитика очереди по статусам, сроки на ближайшую неделю и число закрытых заявок, обновлённых за 30 дней.
...
- Фильтр просроченных заявок и выгрузка отфильтрованного списка в CSV. Публичное статическое демо также показывает сводку, рассчитанную по вымышленным заявкам.
